...
#大家要改成自己的路径
# history_db = '/Users/truexinology/Library/Application Support/Google/Chrome/Default'
...
with open('/Users/truexinology/truexin/python/chrome-history-email/result.txt','w') as f:#改成自己的路径
